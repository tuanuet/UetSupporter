 ...
 */
public class TrashFragment extends Fragment implements RecyclerAdapterInboxAndSentMessage.ClickListener,
    ...
    private void initUI(View view) {
        ...
        recycler.setOnScrollListener(new EndlessRecyclerOnScrollListener(mLayoutManager) {
            ...
            public void onLoadMore(int current_page) {
                presenter.excuteLoadEmail(Config.MailBox.Trash.toString(), current_page);
            }
        });
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        presenter.excuteLoadEmail(Config.MailBox.Trash.toString(), 0);
    }
    ...
    public void onItemClick(int position, View v) {
        ...
        intent.putExtra(Config.FOLDER_EMAIL, Config.MailBox.Trash.toString());
